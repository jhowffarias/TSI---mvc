...
class RoleController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('layouts.roles.index')->with('success','Perfil criado com sucesso');
    }
    ...
    public function edit($id)
    {
        ...
        ->all();
        return view('layouts.roles.edit',compact('role','permission','rolePermissions'));
    }
